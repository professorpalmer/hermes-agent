...
// Session-cwd worktree grouping (distinct from git-worktree-ops): the sidebar
// worktree switcher passes the set of open session cwds and gets back their
// worktree groupings. Preload exposes worktrees(cwds); global.d.ts declares it.
