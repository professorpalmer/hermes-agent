...
class AIAgent:
    ...
    def __init__(
        ...
        init_agent(
            ...
            browser_navigate_callback=browser_navigate_callback,
            browser_read_callback=browser_read_callback,
            browser_act_callback=browser_act_callback,
            browser_extract_callback=browser_extract_callback,
            browser_screenshot_callback=browser_screenshot_callback,
            set_workspace_callback=set_workspace_callback,
